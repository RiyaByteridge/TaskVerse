      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="bg-white w-1/3 h-4/5  border-solid border border-formBorder rounded ">
          ...
          <form className=" flex flex-col justify-between   h-1/2 w-full  px-5 ">
            ...
            <input
              id="email"
              className="w-11/12 my-2 mx-4 px-2 py-2  border rounded border-solid border-formBorder  hover:shadow-sm outline-none text-xs focus:outline-none focus:border-inputBorderColor focus:ring-2 focus:ring-focusRing"
            ...
            <div className="relative ">
              <input
                id="password"
                className=" w-11/12 mb-4 mt-2 px-2 py-2 border rounded border-solid border-formBorder shadow-sm outline-none focus:outline-none focus:border-inputBorderColor focus:ring-2 focus:ring-focusRing text-xs "
